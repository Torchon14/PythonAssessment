...
#variables
v1= 0;v2 = 0; v3 = 0; v4 = 0; v5 = 0; Kind = 0;Premium = 0; fee = 0; Price =0
...
fee = Assesment_function.paymentMethod(fee)
print()
print("You have completed your profile !")
Price = Premium*fee + Premium
print()
print(" Dear customer, you asked for a", v3,"years",Kind,"contract. The total cost is of £",Price)
print()
